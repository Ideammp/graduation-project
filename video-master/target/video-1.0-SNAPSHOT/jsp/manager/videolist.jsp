        ...
        <div style="padding: 15px;">
            <div class="searchDiv">
                <form class="layui-form" action="manager/video/search" method="post">
                    ...
                    <label style="margin-left: 95px; width:150px">菜品上架时间：</label>
                    <div class="layui-input-inline" style="width: 150px;">
                    ...
                    <label style="margin-left: 60px;" >菜品状态：</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <select name="finished"  lay-filter="state" id="state">
                            <option value="">--请选择--</option>
                            <option value="0" <c:if test="${video.finished == false}">selected="selected"</c:if>>菜品未上架</option>
                            <option value="1" <c:if test="${video.finished == true}">selected="selected"</c:if>>火热售卖中</option>
                        </select>
                    </div>
                ...
                <div style="padding:20px;">
                    <table  id="demo" lay-filter="demo" >
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'name',minWidth: 150}">菜品名</th>
                            <th lay-data="{field:'type', width:80}">菜品类型</th>
                            <th lay-data="{field:'categoryList'}">口味标签</th>
                            <th lay-data="{field:'starring',minWidth:120}">窗口负责人</th>
                            <th lay-data="{field:'location',sort: true}">校内位置</th>
                            <th lay-data="{field:'publishDate'}">菜品上架时间</th>
                            <th lay-data="{field:'finished'}">菜品状态</th>
                        ...
                        <tbody>
                            <c:forEach items="${videos}" var="obj">
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${obj.finished == true}">菜品火热销售中</c:if>
                                        <c:if test="${obj.finished == false}">菜品未上架</c:if>
                                    </td>
                                    <td>
    ...
    <form class="layui-form videoAddForm" style="width: 500px;" method="get" action="manager/video/add">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input id="name2" type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入菜品名称" class="layui-input">
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label">上传菜品海报：</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label" for="type2">菜品种类：</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label" for="category2">口味标签：</label>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">菜品上架时间：</label>
                <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">窗口负责人：</label>
            <div class="layui-input-block">
                <input type="starring" lay-verify="required" id="starring2" name="starring" lay-verify="starring" autocomplete="off" placeholder="请输入窗口负责人（多个负责人以空格分隔）" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">校内位置：</label>
            <div class="layui-input-inline">
                <select id="location2" name="location" lay-filter="location">
                    <option value="">--请选择--</option>
                    <option value="清真食堂">清真食堂</option>
                    <option value="L座一楼自营食堂">L座一楼自营食堂</option>
                    <option value="L座一楼麦嘉力餐厅">L座一楼麦嘉力餐厅</option>
                    <option value="L座二楼自营食堂">L座二楼自营食堂</option>
                    <option value="L座二楼麦嘉力餐厅">L座二楼麦嘉力餐厅</option>
                    <option value="L座二楼麦嘉力餐厅">L座二楼教师餐厅</option>
                    <option value="M座食堂一楼西餐厅">M座食堂一楼西餐厅</option>
                    <option value="M座食堂师生餐厅">M座食堂师生餐厅</option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="statue2" name="statue" lay-filter="statue">
                    <option value="">--请选择--</option>
                    <option value="0">菜品未上架</option>
                    <option value="1">火热售卖中</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">菜品总量：</label>
            <input id="totalEpisode" style="width: 200px" type="text" name="totalEpisode" lay-verify="number" autocomplete="off" placeholder="请输入菜品总量（数字）" class="layui-input">
            <div class="layui-input-inline">

            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">菜品已售数量：</label>
            <div class="layui-input-inline">
                <input id="currentEpisode" style="width: 200px" type="text" name="currentEpisode" lay-verify="number" autocomplete="off" placeholder="请输入菜品已售数量（数字）" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">简介：</label>
            <div class="layui-input-block">
                <textarea name="description" id="description" placeholder="请输入菜品描述" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
...
<div style="display: none" id="updateForm" >
    <form class="layui-form videoUpdateForm" style="width: 500px;" method="post" action="manager/video/updateForForm">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">菜品名称：</label>
            <div class="layui-input-block">
                <input id="name3" type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入菜品名称" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">菜品上架年份：</label>
                <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">窗口负责人：</label>
            <div class="layui-input-block">
                <input type="starring" lay-verify="required" id="starring3" name="starring" lay-verify="starring" autocomplete="off" placeholder="请输入窗口负责人（多个负责人以空格分隔）" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">校内位置：</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">菜品总量：</label>
            <input id="totalEpisode3" style="width: 200px" type="text" name="totalEpisode" lay-verify="" autocomplete="off" placeholder="请输入菜品总量（数字）" class="layui-input">
            <div class="layui-input-inline">

            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">已销售菜品数量：</label>
            <div class="layui-input-inline">
                <input id="currentEpisode3" style="width: 200px" type="text" name="currentEpisode" lay-verify="" autocomplete="off" placeholder="请输入已售出菜品数量（数字）" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">简介：</label>
            <div class="layui-input-block">
                <textarea name="description" id="description3" placeholder="请输入菜品描述" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block" style="margin-top: 50px;">
...
layui.use(['element','table','layer','jquery','form','laydate','upload'], function() {
    ...
    table.on('tool(demo)', function(obj) {
        ...
        if (layEvent == 'delete'){
            ...
            layer.confirm('确认删除菜品 \"'+ data.name + '\" ?', {title:'提示'}, function(index){
