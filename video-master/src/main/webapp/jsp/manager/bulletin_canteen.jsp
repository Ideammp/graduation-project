...
<script type="text/html" id="toolbarLeft">
    <div class="layui-inline" title="添加告示" lay-event="addCanteenBulletin">
...
<script>
    ...
    layui.use(['element','table','layer','jquery','form','laydate','upload'], function(){
        ...
        table.render({
            elem: '#demo'
            ,url:'bulletin/getCanteenAll'
            ,toolbar: 'true'
            ,toolbar: '#toolbarLeft'
            ,cols: [[
                {type:'checkbox', width:60, title: '全选'}
                ,{type:'numbers', width:60, title: '序号'}
                ,{field:'canteenBulletinTitle', title: '标题',minWidth: 80}
                ,{field:'canteenBulletinContent',  title: '告示内容',minWidth:100}
                ,{field:'canteenUplodDate', title: '通知时间'}
                ,{field:'operate',title:'操作'
                    ,templet:function (d) {
                        return '<div><a href="bulletin/canteen/detail/'+ d.id +'" class="operateBtn">查看</a><a class="operateBtn" lay-event="delete">删除</a></div>';
                    }
                }
            ]]
            ,page: {
        ...
        * */
        ...
        table.on('toolbar(demo)', function(obj){
            switch(obj.event){
                case 'addCanteenBulletin':    //添加餐厅告示
                    layer.open({
                        type:1
                        ,title:'添加告示'
                        ,area:['700px','720px']
                        ...
                        ,success:function () {
                            ...
                            $("#submit").click(function () {
                                ...
                                if (title == '' || title == null){
                                    ...
                                    $.ajax({
                                        url:"bulletin/canteen/addNewBulletin"
                                        ,type:'post'
