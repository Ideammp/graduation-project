        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="manager/video/list">菜品列表</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;">菜品分类管理</a>
                    <dl class="layui-nav-child">
                        <dd class="layui-this"><a href="manager/category/list">菜品分类列表</a></dd>
                        <dd><a href="manager/category/add">添加菜品分类</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
        ...
        <div style="padding: 15px;">
            ...
            <div style="border: #beb9b0 solid 1px;margin-top: 20px;border-radius: 5px;">
                <div style="border-bottom: #beb9b0 solid 1px;height:40px;">
                    <h2 style="margin:10px 0 10px 15px;">菜品分类列表</h2>
                </div>
    ...
    layui.use(['element','table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'categoryName', title: '口味标签'}
                ,{field:'phone',  title: '菜品种类'
                    ,templet:function (d) {
